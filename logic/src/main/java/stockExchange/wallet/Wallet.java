...
import stockExchange.strategy.impl.RandomStrategy;
import stockExchange.strategy.impl.RiskyStrategy;
import stockExchange.strategy.impl.SafeStrategy;
...
public class Wallet {
	...
	@Autowired
	private RiskyStrategy riskyStrategy;
	@Autowired
	...
	public RiskyStrategy getRiskyStrategy() {
		return riskyStrategy;
	}

	public void setRiskyStrategy(RiskyStrategy riskyStrategy) {
		this.riskyStrategy = riskyStrategy;
	}

	public SafeStrategy getSafeStrategy() {
		return safeStrategy;
	}

	public void setSafeStrategy(SafeStrategy safeStrategy) {
